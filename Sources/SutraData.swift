...
struct SutraChapter: Identifiable {
    let id: Int          // 1...32
    let name: String     // e.g. "法会因由分"
    let ordinal: String  // e.g. "第一"
    let body: String     // full text of the section

    var fullTitle: String { name + ordinal }
}

/// 《金刚般若波罗蜜经》— 姚秦三藏法师鸠摩罗什译. Full text, divided into the
/// traditional 32 分 attributed to 梁昭明太子.
enum Sutra {
    static let title = "金刚般若波罗蜜经"
    static let translator = "姚秦三藏法师 鸠摩罗什 译"

    static let chapters: [SutraChapter] = [
        SutraChapter(id: 1, name: "法会因由分", ordinal: "第一", body:
        """
        如是我闻：一时，佛在舍卫国祇树给孤独园，与大比丘众千二百五十人俱。
        尔时，世尊食时，著衣持钵，入舍卫大城乞食。于其城中次第乞已，还至本处。饭食讫，收衣钵，洗足已，敷座而坐。
        """),

        SutraChapter(id: 2, name: "善现启请分", ordinal: "第二", body:
        """
        时长老须菩提，在大众中即从座起，偏袒右肩，右膝著地，合掌恭敬而白佛言：
        “希有世尊！如来善护念诸菩萨，善付嘱诸菩萨。世尊！善男子、善女人，发阿耨多罗三藐三菩提心，云何应住？云何降伏其心？”
        佛言：“善哉，善哉。须菩提！如汝所说，如来善护念诸菩萨，善付嘱诸菩萨。汝今谛听，当为汝说。善男子、善女人，发阿耨多罗三藐三菩提心，应如是住，如是降伏其心。”
        “唯然，世尊！愿乐欲闻。”
        """),

        SutraChapter(id: 3, name: "大乘正宗分", ordinal: "第三", body:
        """
        佛告须菩提：“诸菩萨摩诃萨，应如是降伏其心：所有一切众生之类，若卵生、若胎生、若湿生、若化生，若有色、若无色，若有想、若无想、若非有想非无想，我皆令入无余涅槃而灭度之。如是灭度无量无数无边众生，实无众生得灭度者。何以故？须菩提，若菩萨有我相、人相、众生相、寿者相，即非菩萨。”
        """),

        SutraChapter(id: 4, name: "妙行无住分", ordinal: "第四", body:
        """
        ...
        SutraChapter(id: 5, name: "如理实见分", ordinal: "第五", body:
        """
        “须菩提！于意云何？可以身相见如来不？”
        ...
        SutraChapter(id: 6, name: "正信希有分", ordinal: "第六", body:
        """
        ...
        SutraChapter(id: 9, name: "一相无相分", ordinal: "第九", body:
        """
        ...
        SutraChapter(id: 10, name: "庄严净土分", ordinal: "第十", body:
        """
        ...
        SutraChapter(id: 11, name: "无为福胜分", ordinal: "第十一", body:
        """
        ...
        SutraChapter(id: 12, name: "尊重正教分", ordinal: "第十二", body:
        """
        “复次，须菩提！随说是经，乃至四句偈等，当知此处，一切世间天、人、阿修罗，皆应供养，如佛塔庙。何况有人尽能受持读诵。须菩提！当知是人成就最上第一希有之法。若是经典所在之处，即为有佛，若尊重弟子。”
        """),

        SutraChapter(id: 13, name: "如法受持分", ordinal: "第十三", body:
        """
        ...
        SutraChapter(id: 14, name: "离相寂灭分", ordinal: "第十四", body:
        """
        尔时，须菩提闻说是经，深解义趣，涕泪悲泣而白佛言：“希有世尊！佛说如是甚深经典，我从昔来所得慧眼，未曾得闻如是之经。世尊！若复有人得闻是经，信心清净，则生实相，当知是人成就第一希有功德。世尊！是实相者，即非实相，是名实相。
        ...
        SutraChapter(id: 15, name: "持经功德分", ordinal: "第十五", body:
        """
        ...
        SutraChapter(id: 16, name: "能净业障分", ordinal: "第十六", body:
        """
        ...
        SutraChapter(id: 17, name: "究竟无我分", ordinal: "第十七", body:
        """
        ...
        SutraChapter(id: 18, name: "一体同观分", ordinal: "第十八", body:
        """
        “须菩提！于意云何？如来有肉眼不？”
        “如是，世尊！如来有肉眼。”
        “须菩提！于意云何？如来有天眼不？”
        ...
        SutraChapter(id: 19, name: "法界通化分", ordinal: "第十九", body:
        """
        ...
        SutraChapter(id: 20, name: "离色离相分", ordinal: "第二十", body:
        """
        “须菩提！于意云何？佛可以具足色身见不？”
        ...
        SutraChapter(id: 21, name: "非说所说分", ordinal: "第二十一", body:
        """
        ...
        SutraChapter(id: 27, name: "无断无灭分", ordinal: "第二十七", body:
        """
        “须菩提！汝若作是念‘如来不以具足相故，得阿耨多罗三藐三菩提’。须菩提！莫作是念‘如来不以具足相故，得阿耨多罗三藐三菩提’。
        须菩提！汝若作是念‘发阿耨多罗三藐三菩提心者，说诸法断灭’。莫作是念！何以故？发阿耨多罗三藐三菩提心者，于法不说断灭相。”
        """),

        SutraChapter(id: 28, name: "不受不施分", ordinal: "第二十八", body:
        """
        ...
        SutraChapter(id: 29, name: "威仪寂净分", ordinal: "第二十九", body:
        """
        “须菩提！若有人言‘如来若来若去、若坐若卧’，是人不解我所说义。何以故？如来者，无所从来，亦无所去，故名如来。”
        """),

        SutraChapter(id: 30, name: "一合理相分", ordinal: "第三十", body:
        """
        ...
        SutraChapter(id: 31, name: "知见不生分", ordinal: "第三十一", body:
        """
        ...
        SutraChapter(id: 32, name: "应化非真分", ordinal: "第三十二", body:
        """
